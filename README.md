...
- [x] Custom detection rule authoring and tuning — 7 MITRE ATT&CK-mapped rules written and confirmed working live: 4 File Integrity Monitoring rules + 3 command-execution monitoring rules (see wazuh-rules/local_rules.xml, detection-notes.md)
